...
# 期待セル列 [No.,名前,数量,時間,工数,担当,予定開始,予定終了,実績開始,実績終了,備考]
EXPECT = {
    ...
    "1.2":       ['2', '16', '4', '鈴木', '6/6', '6/10', '6/6', '進行中'],                       # 工数=2×16÷8=4・実績終了=進行中
...
with sync_playwright() as p:
    ...
    # 1.2: 数量〜実績終了（cells[2:10]）で進行中表示と工数4を確認
    check(l12["cells"][2:10] == EXPECT["1.2"], f"進行中リーフ（工数4・実績終了=進行中）\n     {l12['cells'][2:10]}")
    check(l2["cells"][2:10] == EXPECT["2"], f"未着手リーフ（実績=—）\n     {l2['cells'][2:10]}")
