...
with sync_playwright() as p:
    ...
    check(pg.inner_text("#openBtn") == "Open file", "リロード後もENを記憶")
    pg.click("#langBtn"); pg.wait_for_timeout(100)
    check(pg.inner_text("#openBtn") == "ファイルを開く", "日本語へ復帰")
    b.close()
finish(errors)
